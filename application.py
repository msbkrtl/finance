...
app.secret_key = 'asdsadasdadsadasdwqdwq2313213'
...
def buy():
    ...
    if request.method == "POST":
        ...
        if float(number_of_shares_to_buy) < 1.0:
            return apology("Number of number of shares to buys must be positive number")
...
def sell():
    ...
    if request.method == "POST":
        ...
        if number_of_shares > amount_of_stocks:
            flash(
                f"You only have {amount_of_stocks} shares {stock_infos['name']}", "error")
